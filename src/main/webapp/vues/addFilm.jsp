...
<div class="container card mt-5">
    ...
    <form class="card-body d-flex flex-column needs-validation" action="${pageContext.request.contextPath}/film/ajouter" method="post">
        <div class="border-bottom">
            <div class="mt-3 input-group flex-nowrap">
                <div class="form-floating">
                    <input id="Title" value="${p.title}" name="title" type="text" placeholder="Title" aria-label="Title"
                           class="form-control"
                           required>
            ...
            <div class="mt-3 input-group flex-nowrap">
                <div class="form-floating">
                    <input id="ReleaseDate" value="${p.releaseDate}" name="date" type="date" placeholder="ReleaseDate" aria-label="ReleaseDate"
                           class="form-control"
                           required>
            ...
            <div class="mt-3 input-group flex-nowrap">
                <div class="form-floating">
                    <input id="Duration" value="${p.duration}" name="duration" type="number" placeholder="Duration" aria-label="Duration"
                           class="form-control"
                           required>
