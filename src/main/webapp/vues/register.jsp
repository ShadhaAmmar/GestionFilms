                    ...
                    <div class="card-body p-5 text-center">
                        ...
                        <form method="post" action="register">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="login" data-bs-toggle="tooltip"
                                   data-bs-placement="bottom" data-bs-title="Se connecter">J'ai déjà un compte</a>
                                <button class="btn btn-primary btn-lg btn-block" type="submit" data-bs-toggle="tooltip"
                                        data-bs-placement="bottom" data-bs-title="S'inscrire">Créer un compte
                                </button>
                            </div>
                        </form>
                    </div>
