...
<div class="container card mt-5">
    <div class="container mt-2 border-bottom">
        <h2 class="mb-3">Ajouter un nouveaux genre:</h2>
    </div>
    <form class="card-body d-flex flex-column needs-validation" action="${pageContext.request.contextPath}/genre/ajouter" method="post">
        <div class="border-bottom">
            <div class="mt-3 input-group flex-nowrap">
                <div class="form-floating">
                    <input id="Nom" value="${p.nom}" name="nom" type="text" placeholder="Nom" aria-label="Nom"
                           class="form-control"
                           required>
