...
<div class="container card mt-5">
    ...
    <form class="card-body d-flex flex-column needs-validation" action="${pageContext.request.contextPath}/author/ajouter" method="post">
        <div class="border-bottom">
            ...
            <div class="mt-3 input-group flex-nowrap">
                <div class="form-floating">
                    <input id="BirthDate" value="${a.birthDate}" name="date" type="date" placeholder="Birth Date" aria-label="Birth Date"
                           class="form-control"
                           required>
            ...
            <div class="mt-3 input-group flex-nowrap">
                <div class="form-floating">
                    <textarea id="Bio" name="bio" placeholder="Bio" aria-label="Bio"
                           class="form-control"
                           required>
                    </textarea>
