...
<table class="table container">
            ...
            <div class="d-flex flex-row mx-3 mt-3">
                <div class="d-flex flex-row container">
                    ...
                    <a href="ajouter"
                       ...
                       data-bs-placement="top" data-bs-title="Ajout un nouveaux genre"></a>
                </div>
            </div>
        </div>
    </div>
    <div class="card-body">
        ...
        <tr>
            ...
            <td class="text-center fw-bold">Noms</td>
        ...
        <c:forEach items="${genres}" var="g">
            <tr>
                ...
                <td class="text-center">${g.nom}</td>
                <td class="d-flex justify-content-center text-center">
                    <div class="grid gap-3">
                        <a href="supprimer/${g.id}"
                           ...
                           data-bs-placement="bottom" data-bs-title="Supprimer un genre"></a>
                        <a href="modifier/${g.id}" class="btn btn-warning fa fa-edit text-light"
                           data-bs-toggle="tooltip"
                           data-bs-placement="bottom" data-bs-title="Modifier un genre"></a>
                    </div>
                </td>
            </tr>
        </c:forEach>
